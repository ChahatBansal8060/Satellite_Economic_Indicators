...
var india_image = (ee.Image)(ee.ImageCollection('LANDSAT/LE07/C01/T1_TOA')
                            ...
                            .median()	/*For average data use mean()*/
                            );
...
Export.image.toDrive({
  ...
  description: 'karnatka_2010_2012_median',
  scale: 30,
  maxPixels: 1e11,
  region: currState
});
